...
object Constant {
    ...
    const val appName = "Catalog Movie"
    const val reffMovie = "movie"
    const val reffDaftarMovie = "/4/list/"
    const val reffDetailMovie = "/3/movie/"
    ...
    const val reffURL = "https://api.themoviedb.org"
    const val reffApiKey = "ef12794562ecb503d01d3a9aedff21d0"

    const val reffBaseURLPosterPath = "https://image.tmdb.org/t/p/w500"

    const val menuBeranda = "Beranda"
    const val menuDetail = "Detail Movie"
    ...
    const val noSales = "Maaf, belum ada data catalogmovie"
    const val noMovieRequest = "Semua store telah divalidasi"
    const val noMovie = "Maaf, belum ada data movie"
    ...
    const val formUpdateSales = "Pendaftaran akun catalogmovie Anda ditolak, dengan alasan"
